...
Now you should access CLI script: $ fastapi-mvc-usecase --help
Alternatively you can access CLI script via poetry run: $ poetry run fastapi-mvc-usecase --help
To deactivate virtualenv simply type: $ deactivate
To activate shell completion:
 - for bash: $ echo 'eval "$(_FASTAPI_MVC_USECASE_COMPLETE=source_bash fastapi-mvc-usecase)' >> ~/.bashrc
 - for zsh: $ echo 'eval "$(_FASTAPI_MVC_USECASE_COMPLETE=source_zsh fastapi-mvc-usecase)' >> ~/.zshrc
 - for fish: $ echo 'eval "$(_FASTAPI_MVC_USECASE_COMPLETE=source_fish fastapi-mvc-usecase)' >> ~/.config/fish/completions/fastapi-mvc-usecase.fish
EOF