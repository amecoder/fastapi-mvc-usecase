...
.. code-block:: bash
    ...
    $ fastapi-mvc-usecase --help
    Usage: fastapi-mvc-usecase [OPTIONS] COMMAND [ARGS]...

      Fastapi-mvc-usecase CLI root.
    ...
    Commands:
      serve  fastapi-mvc-usecase CLI serve command.
    $ fastapi-mvc-usecase serve --help
    Usage: fastapi-mvc-usecase serve [OPTIONS]
...
.. code-block:: bash
    ...
    $ make image
    $ podman run -dit --name fastapi-mvc-usecase -p 8000:8000 fastapi-mvc-usecase:$(cat TAG)
    f41e5fa7ffd512aea8f1aad1c12157bf1e66f961aeb707f51993e9ac343f7a4b
    $ podman ps
    CONTAINER ID  IMAGE                                 COMMAND               CREATED        STATUS            PORTS                   NAMES
    f41e5fa7ffd5  localhost/fastapi-mvc-usecase:0.1.0  /usr/bin/fastapi ...  2 seconds ago  Up 3 seconds ago  0.0.0.0:8000->8000/tcp  fastapi-mvc-usecase
    $ curl localhost:8000/api/ready
    {"status":"ok"}
...
You can implement your own web routes logic straight away in ``fastapi_mvc_usecase.controllers`` submodule. For more information please see `FastAPI documentation <https://fastapi.tiangolo.com/tutorial/>`__.
...
.. code-block:: bash
    ...
    Usage:
      ...
      clean-image      Clean fastapi-mvc-usecase image
      install          Install fastapi-mvc-usecase with poetry
      metrics          Run fastapi-mvc-usecase metrics checks
      unit-test        Run fastapi-mvc-usecase unit tests
      integration-test  Run fastapi-mvc-usecase integration tests
      docs             Build fastapi-mvc-usecase documentation
...
* RedisClient ``fastapi_mvc_usecase.app.utils.redis``
* AiohttpClient ``fastapi_mvc_usecase.app.utils.aiohttp_client``
...
.. code-block:: python
    ...
    from fastapi_mvc_usecase.app.utils import RedisClient
...
.. literalinclude:: ../fastapi_mvc_usecase/app/exceptions/http.py
    :language: python
...
All application configuration is available in ``fastapi_mvc_usecase.config`` submodule.
...
.. literalinclude:: ../fastapi_mvc_usecase/config/gunicorn.py
    :language: python

Routes
~~~~~~

Endpoints are defined in ``fastapi_mvc_usecase.app.router`` submodule. Just simply import your controller and include it to FastAPI router:

.. literalinclude:: ../fastapi_mvc_usecase/app/router.py
    :language: python
