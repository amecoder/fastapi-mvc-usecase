...
.. code-block:: bash
    ...
    fastapi-mvc available under: http://fastapi-mvc-usecase.192.168.49.2.nip.io/
...
.. code-block:: bash
    ...
    ...
    Kubernetes cluster ready
    FastAPI available under: http://fastapi-mvc-usecase.192.168.49.2.nip.io/
    You can delete dev-env by issuing: make clean
    vagrant@ubuntu-focal:/syncd$ kubectl get all -n fastapi-mvc-usecase
    NAME                                                     READY   STATUS    RESTARTS   AGE
    pod/fastapi-mvc-usecase-7f4dd8dc7f-p2kr7                1/1     Running   0          55s
    ...
    service/fastapi-mvc-usecase                ClusterIP   10.110.42.252   <none>        8000/TCP    56s
    service/rfs-redisfailover-persistent-keep   ClusterIP   10.110.4.24     <none>        26379/TCP   3m39s

    NAME                                                READY   UP-TO-DATE   AVAILABLE   AGE
    deployment.apps/fastapi-mvc-usecase                1/1     1            1           55s
    deployment.apps/rfs-redisfailover-persistent-keep   3/3     3            3           3m39s

    NAME                                                           DESIRED   CURRENT   READY   AGE
    replicaset.apps/fastapi-mvc-usecase-7f4dd8dc7f                1         1         1       55s
    ...
    vagrant@ubuntu-focal:/syncd$ curl http://fastapi-mvc-usecase.192.168.49.2.nip.io/api/ready
    {"status":"ok"}
Documentation
-------------
